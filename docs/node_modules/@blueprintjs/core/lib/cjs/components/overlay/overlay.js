...
var overlayUtils_1 = require("./overlayUtils");
/**
 * Overlay component.
 *
    ...
    function Overlay() {
        ...
        _this.handleStartFocusTrapElementKeyDown = function (e) {
            ...
            if (e.shiftKey && e.key === "Tab") {
                var lastFocusableElement = (0, overlayUtils_1.getKeyboardFocusableElements)(_this.containerElement).pop();
        ...
        _this.handleEndFocusTrapElementFocus = function (e) {
            ...
            if (e.relatedTarget != null &&
                ...
                var firstFocusableElement = (0, overlayUtils_1.getKeyboardFocusableElements)(_this.containerElement).shift();
