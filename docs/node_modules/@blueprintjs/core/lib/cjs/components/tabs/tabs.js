...
var Tabs = /** @class */ (function (_super) {
    ...
    function Tabs(props) {
        ...
        _this.renderTabPanel = function (tab) {
            ...
            var tabTitleId = (0, tabTitle_1.generateTabTitleId)(_this.props.id, id);
            var tabPanelId = (0, tabTitle_1.generateTabPanelId)(_this.props.id, id);
            return (React.createElement("div", { "aria-labelledby": tabTitleId, "aria-hidden": id !== _this.state.selectedTabId, className: (0, classnames_1.default)(common_1.Classes.TAB_PANEL, className, panelClassName), id: tabPanelId, key: id, role: "tabpanel" }, common_1.Utils.isFunction(panel) ? panel({ tabTitleId: tabTitleId, tabPanelId: tabPanelId }) : panel));
        };
