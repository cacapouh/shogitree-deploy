...
var Tab = /** @class */ (function (_super) {
    ...
    Tab.prototype.render = function () {
        ...
        return (React.createElement("div", { className: (0, classnames_1.default)(common_1.Classes.TAB_PANEL, className), role: "tablist" }, (0, utils_1.isFunction)(panel) ? panel({ tabTitleId: "", tabPanelId: "" }) : panel));
    };
    Tab.defaultProps = {
        disabled: false,
    };
