...
var Tabs = /** @class */ (function (_super) {
    ...
    function Tabs(props) {
        ...
        _this.renderTabPanel = function (tab) {
            ...
            var tabTitleId = generateTabTitleId(_this.props.id, id);
            var tabPanelId = generateTabPanelId(_this.props.id, id);
            return (React.createElement("div", { "aria-labelledby": tabTitleId, "aria-hidden": id !== _this.state.selectedTabId, className: classNames(Classes.TAB_PANEL, className, panelClassName), id: tabPanelId, key: id, role: "tabpanel" }, Utils.isFunction(panel) ? panel({ tabTitleId: tabTitleId, tabPanelId: tabPanelId }) : panel));
        };
