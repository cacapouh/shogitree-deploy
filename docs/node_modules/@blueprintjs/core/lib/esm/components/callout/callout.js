...
var Callout = /** @class */ (function (_super) {
    ...
    Callout.prototype.render = function () {
        var _a;
        var _b = this.props, className = _b.className, children = _b.children, icon = _b.icon, intent = _b.intent, title = _b.title, compact = _b.compact, htmlProps = __rest(_b, ["className", "children", "icon", "intent", "title", "compact"]);
