...
export function showContextMenu(props, options) {
    ...
    var _a = options.container, container = _a === void 0 ? document.body : _a, _b = options.domRenderer, domRenderer = _b === void 0 ? ReactDOM.render : _b, _c = options.domUnmounter, domUnmounter = _c === void 0 ? ReactDOM.unmountComponentAtNode : _c;
