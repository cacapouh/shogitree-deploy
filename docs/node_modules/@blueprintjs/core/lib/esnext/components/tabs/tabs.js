...
export class Tabs extends AbstractPureComponent {
    ...
    renderTabPanel = (tab) => {
        ...
        return (React.createElement("div", { "aria-labelledby": tabTitleId, "aria-hidden": id !== this.state.selectedTabId, className: classNames(Classes.TAB_PANEL, className, panelClassName), id: tabPanelId, key: id, role: "tabpanel" }, Utils.isFunction(panel) ? panel({ tabTitleId, tabPanelId }) : panel));
    };
