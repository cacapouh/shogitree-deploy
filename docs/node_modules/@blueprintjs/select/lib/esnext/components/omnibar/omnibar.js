...
export class Omnibar extends React.PureComponent {
    ...
    renderQueryList = (listProps) => {
        ...
        return (React.createElement(Overlay2, { hasBackdrop: true, ...overlayProps, isOpen: isOpen, className: classNames(Classes.OMNIBAR_OVERLAY, overlayProps.className), onClose: this.handleOverlayClose },
